...
function createMask(updateProgress) {
    var selectedLayerIndex = getSelectedLayersIdx();

    selectLayerByIndex(selectedLayerIndex[0]);
    ...
    for (var p = 0; p < selectedLayerIndex.length; p++) {
        ...
        var percentage = parseInt(p / selectedLayerIndex.length * 100);
...
function activeLayerIsNormalLayer() {
    ...
    return activeLayer.kind === LayerKind.NORMAL && !activeLayer.grouped && activeLayer.visible;
}
